...
Feature: Posts Module Testing
  ...
  Scenario Outline: TC-001 - Create Post with Valid Payload
    ...
    Examples:
      | title            | body                        | userId |
      | My First Post    | This is the body of post 1  |8445087 |
      | Another Post     | This is the body of post 2  |8445087 |
      | Third Post Entry | This is the body of post 3  |8445087 |

  Scenario: TC-002 - Create Post with Non-Existing User ID returns 404 or 400
  ...
  Scenario: TC-003 - Create Post with Empty or Duplicate Payload returns 400 or 409
    When I Send POST request to create a post with empty title and body for userId "8445087"
  ...
  Scenario: TC-004 - Get Post by Valid Post ID returns 200 OK
    When I Send GET post request with post id "278133"
    Then Response status code should be 200
    And Response status line contains "200 OK"
    And Response time less than 3000 ms
    And Validate "Post" schema
    And Response body contains field "id" with value "278133"
  ...
  Scenario: TC-007 - Full Update Post with Valid Payload from Excel returns 200 OK
    When I Send PUT request to update post "278133" with data from excel
    Then Response status code should be 200
    And Response status line contains "200 OK"
    And Response time less than 3000 ms
  ...
  Scenario: TC-009 - Full Update Post with Invalid Data Types returns 400 or 422
    When I Send PUT request to update post "278133" with invalid data types
    Then Response status code should be 400
    And Response status line contains "Bad Request"
    And Response time less than 3000 ms
  ...
  Scenario: TC-010 - Delete Post with Valid Post ID returns 200 or 204
    When I Send DELETE request for post "278133"
    Then Response status code should be 200
    And Response status line contains "200 OK"
    And Response time less than 3000 ms
  ...
  Scenario: TC-012 - Get Deleted Post returns 404 Not Found
    Given post "278133" has already been deleted
    When I Send GET post request with post id "278133"
    Then Response status code should be 404
    And Response status line contains "Not Found"
    And Response time less than 3000 ms
  ...
  Scenario: TC-013 - POST /posts with Invalid or Expired Token returns 401 or 403
  ...
  Scenario: TC-014 - DELETE /posts/{id} with Invalid or Expired Token returns 401 or 403
  ...
  Scenario: TC-015 - GET /posts with Invalid or Expired Token returns 401 or 403
